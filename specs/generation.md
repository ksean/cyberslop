...
`DifficultyCurve.at(mapIndex)` interpolates linearly in `d = (mapIndex − 1) / 9`, clamped to the
measured budget. Every field moves in one direction.

| Parameter | Map 1 | Map 10 |
|---|---|---|
| width (tiles) | 320 | 720 |
| gap frequency | 0.12 | 0.42 |
| hazard frequency | 0.00 | 0.55 |
...
| damaging hazards per 100 tiles | 0 | 5 |
...
of gap fraction (60), hazard fraction (55), jet pressure (25), verticality (12) and openness (1).
